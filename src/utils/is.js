...
var isType = function (type) { return function (value) { return Object.prototype.toString.call(value) === "[object " + type + "]"; }; };
exports.is = {
...
var isEmptyObject = function (obj) { return exports.is.Object(obj) && Object.keys(obj).length === 0; };
exports.isEmptyObject = isEmptyObject;
var isEmpty = function (val) { return (exports.is.String(val) && val.trim() === '') || val === undefined || val === null; };
exports.isEmpty = isEmpty;
var isInstanceOf = function (val, base) {
    try {
...
var objectAssignConcat = function (target, source) {
